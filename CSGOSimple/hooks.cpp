...
#include "G:\CSGOSimple-master\CSGOSimple\clantagchanger.hpp"
#include "features/chams.hpp"
#include "features/visuals.hpp"
#include "features/glow.hpp"
#include "G:\CSGOSimple-master\CSGOSimple\backtrack.h"
...
namespace Hooks
{
	...
	void __stdcall hkCreateMove(int sequence_number, float input_sample_frametime, bool active, bool& bSendPacket)
	{
		...
		if (g_Options.misc_edgejump)
			Edgejump::OnCreateMove(cmd);
		if (g_Options.misc_clantagchanger)
			ClantagChanger::Get().OnCreateMove();
		if (g_Options.misc_backtrack)
			BackTrack::Get().OnCreateMove(cmd);
